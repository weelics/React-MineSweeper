function Block(props) {
  ...
  return (
    <span
      onClick={() => {
        props.checkBoard();
        if(props.content.isBomb) props.gameOver();
        props.setVisible();
        props.addPoints();
      }
